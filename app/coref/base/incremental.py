...
import app.coref.base.higher_order as ho
...
class CorefModel(nn.Module):
    ...
    def load_state_dict(self, state_dict: 'OrderedDict[str, Tensor]',
        ...
        if 'emb_antecedent_distance_prior.weight' in state_dict and state_dict['emb_antecedent_distance_prior.weight'].shape != new_shape:
            logger.warning('Saved embedding for distance is of different size, some values are initialized randomly.')
        ...
        if emb_segment_distance_weight in state_dict and state_dict[emb_segment_distance_weight].shape != new_shape:
            logger.warning('Saved embedding for segment distance is of different size, some values are initialized randomly.')
